...
public class CustomWatchFace extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            Resources resources = CustomWatchFace.this.getResources();
        ...
        private void registerReceiver() {
            ...
            CustomWatchFace.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            CustomWatchFace.this.unregisterReceiver(mTimeZoneReceiver);
        }
    ...
    private static class EngineHandler extends Handler {
        private final WeakReference<CustomWatchFace.Engine> mWeakReference;

        public EngineHandler(CustomWatchFace.Engine reference) {
            mWeakReference = new WeakReference<>(reference);
        }

        @Override
        public void handleMessage(Message msg) {
            CustomWatchFace.Engine engine = mWeakReference.get();
            if (engine != null) {
                switch (msg.what) {
